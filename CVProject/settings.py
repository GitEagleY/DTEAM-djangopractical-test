...
SECRET_KEY = 'django-insecure-)n&d*jp3=djpclouxwgbtsdwccf-u7jo==@dghzbhmjw763y&!'
...
MIDDLEWARE = [
    ...
    'main.middleware.LogRequestsMiddleware',
]
...
if USE_MAILHOG:
    ...
    EMAIL_HOST = os.getenv('MAILHOG_HOST', 'mailhog')
    EMAIL_PORT = int(os.getenv('MAILHOG_PORT', '1025'))
    EMAIL_USE_TLS = False
    EMAIL_USE_SSL = False
    EMAIL_HOST_USER = ''
    EMAIL_HOST_PASSWORD = ''
    DEFAULT_FROM_EMAIL = 'noreply@cvproject.com'
else:
    ...
    DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@cvproject.com')